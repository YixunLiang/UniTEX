...
class NVDiffRendererInverse(nn.Module):
    ...
    def mv_to_pcd(
        ...
        if filt_gradient_points:
            ...
            max_pool = nn.MaxPool2d(kernel_size=grad_dilation_kernel, stride=1, padding=(grad_dilation_kernel-1)//2)
    ...
    def infer(
        ...
        render_mv_out = self.mv_to_pcd(
            ...
            filt_large_angle_points=filt_large_angle_points,
